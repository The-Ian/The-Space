...
Go
Create Trigger SourceIDDeletionCheck
On Sources
After Delete
As
IF EXISTS
...
BEGIN
	RAISERROR ('The SourceID is being referenced in the Leads table. 
	Record not deleted.', 16, 1);
...
Go
Create Trigger BusinessTypeDeletionCheck
On BusinessTypes
After Delete
As
IF EXISTS
...
BEGIN
	RAISERROR ('The Business Type is being referenced in the Companies table. 
	Record not deleted.', 16, 1);
	Rollback Transaction
END;
GO
...
Go
Create Trigger CompanyIDDeletionCheck
On Companies
After Delete
As
IF EXISTS
...
BEGIN
	RAISERROR ('The CompanyID is being referenced in the Leads table. 
	Record not deleted.', 16, 1);
	Rollback Transaction
END;
GO
...
Go
Create Trigger ContactIDDeletionCheck
On Contacts
After Delete
As
IF EXISTS
...
BEGIN
	RAISERROR ('The ContactID is being referenced in the Leads table. 
	Record not deleted.', 16, 1);
	Rollback Transaction
END;
GO
...
BEGIN
	RAISERROR ('The Company ID entered does not exist. Please enter a valid Company ID.', 16, 1);
END;
GO
...
BEGIN
	RAISERROR ('The Contact ID entered does not exist. Please enter a valid Contact ID.', 16, 1)
	Rollback Transaction
END;
GO

Go
Create Trigger SourceIDCheck
On Leads
After Insert, Update
As
IF EXISTS
...
BEGIN
	RAISERROR ('The SourceID entered does not exist. Please enter a valid Source ID.', 16, 1)
	Rollback Transaction
END;
GO

Go
Create Trigger LeadIDDeletionCheck
On Leads
After Delete
As
IF EXISTS
...
BEGIN
	RAISERROR ('The LeadID is being referenced in the Activities table. 
	Record not deleted.', 16, 1);
	Rollback Transaction
END;
GO
...
BEGIN
	RAISERROR ('The Lead ID entered does not exist. Please enter a valid Lead ID.', 16, 1);
	Rollback Transaction
END;
GO
